...
declare const _default: React.ComponentType<Pick<YearProps & Pick<PropTypes.InferProps<any>, string | number | symbol>, string | number | symbol> & import("@material-ui/core").StyledComponentProps<"root" | "disabled" | "selected">>;

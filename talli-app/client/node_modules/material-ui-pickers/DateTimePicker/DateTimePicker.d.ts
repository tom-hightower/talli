...
declare const _default: React.FunctionComponent<Pick<DateTimePickerProps, "initialFocusedDate" | "onChange" | "ampm" | "date" | "maxDate" | "minDate" | "disablePast" | "disableFuture" | "showTabs" | "shouldDisableDate" | "leftArrowIcon" | "rightArrowIcon" | "renderDay" | "allowKeyboardControl" | "animateYearScrolling" | "dateRangeIcon" | "timeIcon" | "autoSubmit" | "openTo" | "ViewContainerComponent">>;
